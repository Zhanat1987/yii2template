...
<!--            </li>-->
            <li class="has-sub">
                ...
                <ul class="sub">
                    <li>
                        <a class="" href="<?php echo Url::to('/pthreads-org/index'); ?>">
                    ...
                    <li>
                        <a class="" href="<?php echo Url::to('/pthreads-org/links'); ?>">
                            <span class="sub-menu-text">
                                Ссылки
                            </span>
                        </a>
            ...
            <li class="has-sub">
                ...
                <ul class="sub">
                    ...
                    <li><a class="" href="fixed_header_sidebar.html"><span class="sub-menu-text">
            ...
            <li><a class="" href="gallery.html"><i class="fa fa-picture-o fa-fw"></i> <span class="menu-text">
                        Gallery</span></a>
            </li>
            <li class="has-sub">
                <a href="javascript:;" class="">
